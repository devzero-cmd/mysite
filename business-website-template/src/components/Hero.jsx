      ...
      <Helmet>
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            description:
              "MIKIRO leverages cutting-edge AI and advanced technologies to deliver innovative solutions across multiple industries. We specialize in intelligent systems, automation, and data-driven research to empower businesses to scale efficiently.",
            sameAs: [
